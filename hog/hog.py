...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        return False
    p = gcdd(player_score, opponent_score)
    if p >= 10:
        return True
    return False
    # END PROBLEM 4a
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def f(score0, score1):
        if who == 0:
            gain0, rh0 = score0 - last_score, running_high
            if gain0 > rh0:
                rh0 = gain0
                print(gain0, 'point(s)! The most yet for Player', who)
                return announce_highest(who, score0, rh0)
            return announce_highest(who, score0, running_high)
        
        elif who == 1:
            gain1, rh1 = score1 - last_score, running_high
            if gain1 > rh1:
                rh1 = gain1
                print(gain1, 'point(s)! The most yet for Player', who)
                return announce_highest(who, score1, rh1)
